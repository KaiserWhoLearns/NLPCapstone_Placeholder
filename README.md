## Reproducibility Project: SimCSE: Simple Contrastive Learning of Sentence Embeddings

### Kaiser's Cats: Ivan, Skyler, and Kaiser

This repository contains the code and pre-trained models for the paper [SimCSE: Simple Contrastive Learning of Sentence Embeddings](https://arxiv.org/abs/2104.08821), as well as the code written for CSE481N NLP Capstone reproducibility project. The paper was written by Tianyu Gao, Xingcheng Yao, and Danqi Chen.

## Overview

This paper proposes a simple contrastive learning framework that works with both unlabeled and labeled data. Unsupervised SimCSE simply takes an input sentence and predicts itself in a contrastive learning framework, with only standard dropout used as noise. Our supervised SimCSE incorporates annotated pairs from NLI datasets into contrastive learning by using `entailment` pairs as positives and `contradiction` pairs as hard negatives. The following figure is an illustration of the models from the paper.
